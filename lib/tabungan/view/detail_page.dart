...
class _DetailPageState extends State<DetailPage> {
  ...
  static const bgColor = Color(0xFFDAF1DE);
  static const cardColor = Color(0xFFDAF1DE);
  static const softCardColor = Color(0xFF8EB69B);
  static const selectedColor = Color(0xFF8EB69B);
  static const brownColor = Color(0xFF051F20);
  static const textColor = Color(0xFF051F20);
  static const borderColor = Color(0xFF8EB69B);
  static const buttonColor = Color(0xFF235347);
  static const greenColor = Color(0xFF8EB69B);
  static const redColor = Color(0xFF235347);
  ...
  Future<void> loadRiwayat() async {
    final data = await repository.getRiwayatTabungan(
      item['id'],
    );
  ...
  Future<void> hapusData(BuildContext context) async {
    ...
    if (confirm == true) {
      await repository.deleteTabungan(item['id']);
  ...
  Future<void> simpanCatatanTabungan() async {
    ...
    await repository.updateTerkumpul(
      item['id'],
      terkumpulBaru,
    );

    await repository.insertRiwayatTabungan({
      'tabungan_id': item['id'],
      'nominal': nominal,
  ...
  void tampilDialogCatatanTabungan() {
    showDialog(
      context: context,
      barrierColor: const Color(0xFF051F20).withOpacity(0.45),
      builder: (context) {
